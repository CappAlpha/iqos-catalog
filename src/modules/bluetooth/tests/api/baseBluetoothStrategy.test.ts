...
import { BaseBluetoothStrategy } from "../../features/api/baseBluetoothStrategy";
import type {
...
class TestBluetoothStrategy extends BaseBluetoothStrategy {
...
describe("BaseBluetoothStrategy", () => {
